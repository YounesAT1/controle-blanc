...
@section('content')
  <div class="container mt-5 my-4">
    <h1 class="text-2xl font-bold mb-4">Offres de {{ $entreprise->nom }}</h1>
  ...
  <a href="{{ route('entreprise.index') }}" class="text-white bg-indigo-400 p-2 rounded ">Liste d'entreprises</a>
@endsection
